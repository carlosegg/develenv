...
<script type="text/javascript">var _gaq = _gaq || [];
  ...
  <body class="composite">
   ...
   ?></span>
    ...
    <div id="bodyColumn">
      <div id="contentBox">
        <!-- Generado con el arquetipo: standalone-archetype --><!-- http://pimpam.googlecode.com --><div class="section"><h2>Verificaci&#xf3;n descarga<a name="Verificacin_descarga"></a></h2><!-- ~~~~~~~~~~ --><p>Antes de proceder a la importaci&#xf3;n de la m&aacute;quina virtual hay que comprobar la integridad de la descarga utilizando MD5. Para ello se debejen ejecutar los siguientes comandos:</p><div class="source"><pre>root@ironman:/tmp$ # Se calcula el md5 del fichero descargado
root@ironman:/tmp$ md5sum <?php echo $downloadArtifact;?> &gt; md5calculated
root@ironman:/tmp$ #Se obtiene el md5 que hay publicado en http://85.214.82.106/public/downloads/<?php echo $downloadArtifact;?>.md5 
root@ironman:/tmp$ wget http://85.214.82.106/public/downloads/<?php echo $downloadArtifact;?>.md5  
