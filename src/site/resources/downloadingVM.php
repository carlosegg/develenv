...
<!-- Generated by Apache Maven Doxia at 27-feb-2011 -->
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  ...
  echo ' <meta http-equiv="refresh" content="0;url=http://develenvms.softwaresano.com/' . $route . '">'
?>     
...
?><a name="develenv"></a></h2><!-- ~~~~~~~~~~ --><p>Descargando <a href="http://develenvms.softwaresano.com/<?php echo $route?>"><b><?php 
echo $component;
...
?>. <p>Si en unos instantes no empieza la descarga pulsa <a href="http://develenvms.softwaresano.com/<?php echo $route?>">aqu&#xed;</a>.(NOTA: El inicio de la descarga puede retrasarse si se accede  a trav&eacute;s de un proxy que revisa el contenido de la descarga)</p><p>Una vez descargado <a href="http://develenvms.softwaresano.com/<?php echo $route?>"><b><?php echo $component 
?></b> </a>se han de seguir los siguientes pasos:</p><!-- ~~~~~~~~~~~~~~ --><ul>
<li><a href="./downloadVMOk.php?artifact=<?php
echo $component;
?>">Comprobar integridad de la descarga</a></li>
<li><a href="./virtualMachines.html#Importacin_mquina_virtual"> Importar Máquina Virtual</a></li></div>
      </div>
    </div>
    <div class="clear">
      <hr/>
