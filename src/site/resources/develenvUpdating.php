...
?></span>
    ...
    <div id="bodyColumn">
      <div id="contentBox">
        <!-- Generado con el arquetipo: standalone-archetype --><!-- http://pimpam.googlecode.com --><div class="section"><h2><?php echo $component . " está actualizandose en estos momentos. Por favor inténtelo más tarde";
?></h2><!-- ~~~~~~~~~~ --></div></div>
      </div>
    </div>
    <div class="clear">
