...
?></span>
    ...
    <div id="bodyColumn">
      <div id="contentBox">
        <!-- Generado con el arquetipo: standalone-archetype --><!-- http://pimpam.googlecode.com --><div class="section"><h2><?php echo $component . " no está disponible";
?></h2><!-- ~~~~~~~~~~ --><p>Para descargarse una release pulsa <a href="./downloads/releases.html">aqu&#xed;</a>, y <a href="./downloads/snapshots.html">aqu&#xed;</a> para descargarse la &#xfa;ltima snapshot.</p></p></div></div>
      </div>
    </div>
    <div class="clear">
      <hr/>
