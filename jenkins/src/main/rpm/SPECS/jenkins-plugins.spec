...
Release:    136.17.gc592238.%{os_release}
...
Requires:   ss-develenv-jenkins >= 1.627-17.gc592238 ss-develenv-sonar-runner >= 2.4-2295.174 graphviz subversion mercurial git lcov sloccount
Vendor:     tid.es
