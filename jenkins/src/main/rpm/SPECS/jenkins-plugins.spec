...
Release:    136.23.g021e3b4.%{os_release}
...
Requires:   ss-develenv-jenkins >= 1.634-23.g021e3b4.%{os_release} ss-develenv-sonar-runner >= 2.4-2295.174 graphviz subversion mercurial git lcov sloccount
Vendor:     tid.es
