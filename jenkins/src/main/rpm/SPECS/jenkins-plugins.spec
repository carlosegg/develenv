...
Release:    136.20.geb6c51c.%{os_release}
...
Requires:   ss-develenv-jenkins >= 1.630-20.geb6c51c ss-develenv-sonar-runner >= 2.4-2295.174 graphviz subversion mercurial git lcov sloccount
Vendor:     tid.es
